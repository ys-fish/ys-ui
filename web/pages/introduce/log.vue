<template>
  <div style="display: flex; height: 100%">
    <div
      ...
      ref="homeRef"
    >
      <a href="#section1" id="link1" class="text-h1">更新日志(3.x)</a>
      <p class="docs">
        Ys 组件库始终在开发中，不断的更新和打磨组件，比提供更好的使用体验
      </p>

      <div style="margin-top: 10px"></div>
      <a href="#section2" id="link2" class="text-h2">未来组件</a>
      <div style="margin-top: 10px"></div>

      <y-table></y-table>
      <div style="margin-top: 10px"></div>
      <a href="#section2" id="link2" class="text-h2">版本发布</a>
      <div style="margin-top: 10px"></div>
    </div>
